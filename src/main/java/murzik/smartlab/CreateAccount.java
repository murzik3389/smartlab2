...
public class CreateAccount extends AppCompatActivity {
    ...
    private Spinner accountSexSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accountSexSpinner.setAdapter(adapter);



        // Слушатель выбора элемента Spinner
        accountSexSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void goanalyse(View view) {
